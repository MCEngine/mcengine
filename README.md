...
- `MCENGINE_GITHUB_TOKEN_PKG_PUBLISH_MCENGINE` – Token used to publish the API to the repository in [`MCEngine`](https://github.com/orgs/MCEngine/packages?repo_name=mcengine). This token is only valid for [`MCEngine`](https://github.com/MCEngine/mcengine).
...
We created My GPTs [`link`](https://chatgpt.com/g/g-67adc66fd9288191955a51d153761eea-mcengine).

## ⚠ Warning

Before using My GPTs, please read the information on this [`website`](https://mcengine.github.io/information/tools/ai/gpts/mcengine) first.
